        ...
        <section class="content">
            <div class="container-fluid">
                <!-- Small boxes (Stat box) -->
                    ...
                    <form id="add-roomservice-type-form" action="<?= ADMIN_URL . 'roomservice/save-add.php'?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
...
<script>
    $('#add-roomservice-type-form').validate({
        rules:{
            name: {
                required: true,
                maxlength: 191,
                remote: {
                    url: "<?= ADMIN_URL . 'roomservice/verify-name-type-existed.php'?>",
                    type: "post",
                    data: {
                        name: function() {
