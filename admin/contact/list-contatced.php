...
$getContactsQuery = "select c.*, u.name as staffName from contact c join users u
                                on c.reply_by = u.id";
...
if ($keyword !== "") {
    $getContactsQuery .= " where (c.name like '%$keyword%'
                            ...
                            or c.reply_content like '%$keyword%')";
}
// dd($getContactsQuery);
                            ...
                            <tbody>
                                <?php foreach ($contacts as $contact) : ?>
                                    <tr>
                                        ...
                                        <td><?php echo $contact['reply_content'] ?></td>
                                        <td>
                                            <?php if ($_SESSION[AUTH]['role_id'] > 1) : ?>
                                                <a href="<?php echo ADMIN_URL . 'contact/reply.php?id=' . $contact['id'] ?>" class="btn btn-sm btn-success">
                                                    <i class="far fa-comment-dots"></i>
                                                </a>
                                            <?php endif; ?>
                                            <?php if ($_SESSION[AUTH]['role_id'] > 1) : ?>
                                                <a href="<?php echo ADMIN_URL . 'contact/remove.php?id=' . $contact['id'] ?>" class="btn-remove btn btn-sm btn-danger">
